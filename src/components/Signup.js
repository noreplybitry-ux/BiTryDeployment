        ...
        <div className="modal-overlay" onClick={() => setShowTermsModal(false)}>
          ...
          >
            ...
            >
              ...
              <p>
                Welcome to BiTry. These Terms explain simple rules for using our
                platform. Please read them before creating or using an account.
                If you continue using BiTry, it means you agree to these Terms
                and our Privacy Policy.
              </p>

              <h4 style={{ marginTop: "28px" }}>1. What BiTry Is</h4>
              <p>
                BiTry is a learning platform with a crypto trading simulator,
                lessons, quizzes, and mini games. It is for education and skill
                practice only.
              </p>

              <h4>2. Not Financial Advice</h4>
              <p>
                BiTry does not give financial, investment, legal, or tax advice.
                All content is for learning only. Any decision you make in real
                life is your own responsibility.
              </p>

              <h4>3. Virtual Money Only</h4>
              <p>
                Trading inside BiTry uses virtual money and points (such as
                $barya). These are not real money, have no cash value, and
                cannot be withdrawn, transferred, or exchanged for real assets.
              </p>

              <h4>4. Who Can Use BiTry</h4>
              <p>
                You must give truthful information when signing up. Features may
                be limited based on age. Some parts of the platform are intended
                for users who are legally allowed to use them in their location.
              </p>

              <h4>5. Your Account and Security</h4>
              <p>
                Keep your login details private. You are responsible for
                activity under your account. If you think someone accessed your
                account without permission, contact us right away.
              </p>

              <h4>6. Acceptable Use</h4>
              <p>You agree not to misuse BiTry. For example, do not:</p>
              <ul>
                <li>Use bots, scripts, hacks, or other unfair automation</li>
                <li>Try to break, overload, or damage the platform</li>
                <li>Access accounts, data, or systems without permission</li>
                <li>Post harmful, abusive, illegal, or misleading content</li>
                <li>Use BiTry to scam, cheat, or violate any law</li>
              </ul>

              <h4>7. Data Privacy</h4>
              <p>
                We collect and process personal information to run the platform,
                secure accounts, and improve user experience. Please read the
                Privacy Policy below for full details on what data we collect and
                how we use it.
              </p>

              <h4>8. Content and Ownership</h4>
              <p>
                BiTry and its content (including lessons, quizzes, visuals,
                branding, and software) are owned by BiTry or its partners. You
                may use the platform for personal learning, but you may not copy,
                sell, or redistribute content without permission.
              </p>

              <h4>9. Service Availability and Liability</h4>
              <p>
                We work hard to keep BiTry available and accurate, but we cannot
                promise uninterrupted service or error-free content at all times.
                To the extent allowed by law, BiTry is not liable for indirect
                losses from using or being unable to use the platform.
              </p>

              <h4>10. Changes, Suspension, and Contact</h4>
              <p>
                We may update these Terms when needed. Continued use after
                updates means you accept the new version. We may suspend or close
                accounts that violate these Terms. For questions, contact
                noreplybitry@gmail.com.
              </p>
            </div>
            <div className="modal-footer">
              <button
        ...
        >
          ...
          >
            ...
            >
              ...
              <p>Last updated: April 20, 2026</p>
              <p>
                This Privacy Policy explains in simple terms what information we
                collect, why we collect it, and how we protect it when you use
                BiTry.
              </p>
              ...
              <p>We may collect:</p>
              <ul>
                <li>Account details like name, email, and date of birth</li>
                <li>Login data from Google if you use Google sign in</li>
                <li>
                  Usage data like pages visited, quiz progress, and simulator
                  activity
                </li>
                <li>Technical data like device, browser, IP address, and logs</li>
                <li>Cookie or similar data to keep sessions and improve service</li>
              </ul>
              ...
              <ul>
                ...
                <li>Provide platform features and learning content</li>
                <li>Track progress and improve user experience</li>
                <li>Send important service or account notices</li>
                <li>Prevent fraud, abuse, and policy violations</li>
                <li>Comply with legal obligations</li>
              </ul>

              <h4>3. Data Privacy and Sharing</h4>
              <p>
                We do not sell your personal data. We only share data when
                needed to operate BiTry, such as with trusted providers for
                authentication, hosting, analytics, market data, and AI tools,
                or when required by law.
              </p>

              <h4>4. Data Security</h4>
              <p>
                We apply reasonable security measures to protect your
                information. However, no online system is 100 percent secure, so
              ...
              <p>
                ...
                information, subject to legal and operational limits. You may
                also control cookies through your browser settings.
              </p>

              <h4>6. Child and Age Related Data</h4>
              <p>
                BiTry applies age related access rules. If we learn that data was
                collected in a way that violates our policy or the law, we will
                take steps to remove or restrict it.
              </p>

              <h4>7. Policy Updates</h4>
              <p>
                We may update this Privacy Policy when needed. We will post the
                new version here with an updated date. Continued use of BiTry
