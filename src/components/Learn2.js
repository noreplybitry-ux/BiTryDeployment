              ...
              >
                ...
                <div className="module-card-content">
                  <p className="module-intro">
                    {module.content?.intro ? module.content.intro.substring(0, 150) + "..." : "Click to view module content..."}
                  </p>
      ...
      <div className={`modal-overlay ${isEditModalOpen ? "" : "hidden"}`}>
        <div className="modal-content module-content-modal">
          <div className="modal-header">
            ...
            <button className="modal-close" onClick={closeEditModal} disabled={isUpdating}>
              ✕
            </button>
          </div>
          <div className="modal-body">
            <form className="module-form" onSubmit={handleEditSubmit}>
              ...
              <div className="form-group">
                ...
                {editFormData.sections.map((section, index) => (
                  <div key={index} className="section-edit-group" style={{
                    border: '1px solid var(--border)',
                    borderRadius: '8px',
                    padding: '16px',
                    marginBottom: '16px',
              ...
              <div className="form-actions">
                <button type="submit" className="btn btn-accent" disabled={isUpdating}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <p style={{
                      ...
                      Modify existing module content, add or remove sections, and update titles and descriptions.
                    </p>
                  </div>
                </div>
              </div>
